...
public class DishPluginTest
{
    ...
    public async Task ValidResponseShouldBeParsed()
    {
        ...
        var jsonFilePath1 = Path.Combine(Directory.GetCurrentDirectory(), "..", "..", "..", "valid_api_responses/dish_example_1.json");
        ...
        var jsonFilePath2 = Path.Combine(Directory.GetCurrentDirectory(), "..", "..", "..", "valid_api_responses/dish_example_2.json");
